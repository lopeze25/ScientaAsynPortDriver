An [EPICS](https://epics-controls.org/) asynPortDriver implementation for controlling a Scienta R4000 hemispherical electron analyzer done at Argonne National Laboratory.
