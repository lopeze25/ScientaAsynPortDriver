...
/* Generated from ../O.Common/asynTest.dbd */
...
epicsShareExtern void (*pvar_func_ScientaAsynDriverConfigure)(void);
...
int asynTest_registerRecordDeviceDriver(DBBASE *pbase)
{
    const char *bldTop = "C:/epics/asynTest";
    ...
    (*pvar_func_ScientaAsynDriverConfigure)();
...
static const iocshFuncDef registerRecordDeviceDriverFuncDef =
                {"asynTest_registerRecordDeviceDriver",1,registerRecordDeviceDriverArgs};
static void registerRecordDeviceDriverCallFunc(const iocshArgBuf *)
{
    asynTest_registerRecordDeviceDriver(*iocshPpdbbase);
}
